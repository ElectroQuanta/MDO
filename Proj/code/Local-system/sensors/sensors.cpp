...
namespace DeviceDriver{
    const std::string Sensor::writePath = "/sys/class/distance-sensor/sysfs_configure";
    const std::string Sensor::readPath = "/sys/class/distance-sensor/distance_";

    Sensor::Sensor(int trig, int echo, int timeout) {
        /**< Attribute variables */
        this->trig = trig;
        this->echo = echo;
