...
// src: https://github.com/MukeshKumarS/OpenCV/blob/master/AlphaBlending/alphaBlend.cpp
//
...
int main(int argc, char** argv)
{
    ...
    //Mat foreGroundImage = imread("../img/foreGroundAsset.png", -1);
    Mat foreGroundImage = imread("../img/glass.png", -1);
    Mat bgra[4];
