...
As it can be seen, there's an alternate way to go to the user, that's because on the authentication the \texttt{Remote Client Back-End} will discover if the user is an \texttt{Admin} or a \texttt{Brand}.
In both cases, it shows its main menu and it can end the sequence through the 'Logout'.
