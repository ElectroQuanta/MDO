...
\begin{item-c}
%
\item \emph{\texttt{Request Handler}}: handles incoming requests from the
  ...
  its output.
%  
\item \emph{\texttt{Mode manager}}: Upon successful initialization the
  ...
  recognizable gesture. If the \texttt{User} choose to select an image filter,
  ...
  or after a timeout. Lastly, if the \texttt{User} chooses to share the image or
