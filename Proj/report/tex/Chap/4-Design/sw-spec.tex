...
\texttt{rxFrame} --- which contains a \texttt{header}, the data length, and the
actual data. The \texttt{header} defines the frame type which can be \texttt{DB}
...
\texttt{AdFrame} is encapsulated within a \texttt{rxFrame}.
...
\begin{figure}[htb!]
\centering
    \includegraphics[width=1.0\columnwidth]{./img/class-diag-rs.png}
