...
6) database
  ...
  #+BEGIN_SRC plantuml :file diags/plantuml/component-diag/output/component-diag.png
@startuml
...
'' MDO-RS
[RCT] ..> sockRC_RS
sockRC_RS ..> [RSRC]: send db \nquery frame

@enduml
  #+END_SRC

  #+RESULTS:
  [[file:diags/plantuml/component-diag/output/component-diag.png]]
