...
'' MDO-RS
'' Client Connections
[RCT] ..> sockRC_RS: send server\nframe
sockRC_RS ..> [RSRC] 
[RSTC] ..> sockRS_RC: send client\nframe
sockRS_RC ..> [RCR]
'' Local connections
[RSTL] .r.> sockRS_L: send local\nframe 
sockRS_L .d.> [LCR]
[LCT] .u.> sockL_RS: send server\nframe 
sockL_RS .l.> [RSRL]
'' Database connections
[RSQP] --> sockRS_SQL: db query
sockRS_SQL --> [SERVRx]
[SERVTx] ..> sockSQL_RS: db response 
sockSQL_RS ..> [RSRP]
