...
4. [ ] Design phase: <2021-12-15 qua 23:00>
...
'' Client Connections
[RCT] .r.> sockRC_RS
sockRC_RS .d.> [RSRC]: send server\nframe
[RSTC] .u.> sockRS_RC
sockRS_RC .l.> [RCR]: send client\n frame
...
package "MDO-RS: DB Server"{
  ''[DB Transaction\n Manager] as DBTM
  [DB Manager] as RSDBM2
  frame "Comm Manager" as CMDB{
  [Comm \nStatus] as DBSt
  [Server \nTx] as SERVTx
  [Server \nRx] as SERVRx
  }
...
'' MDO-Local
'' Cloud connections
[WEBTx] ..> sockL_Twitter #darkred: <color:darkred>twitter\n<color:darkred>cmd
sockL_Twitter ..> REST #darkred
[WEBTx] --> sockL_Transfer_sh: URL proxy\ncmd
sockL_Transfer_sh --> URLP
...
sockRS_RC ..> [RCR] #blue
'' Local connections
[RSTL] ..> sockRS_L #darkgreen: <color:darkgreen>send local\n<color:darkgreen>frame
sockRS_L ..> [LCR] #darkgreen
[LCT] ..> sockL_RS #darkgreen: <color:darkgreen>send server\n<color:darkgreen>frame
sockL_RS ..> [RSRL] #darkgreen
'' Database connections
[RSQP] --> sockRS_SQL #indigo: <color:indigo>db\n<color:indigo>query
sockRS_SQL --> [SERVRx] #indigo
[SERVTx] ..> sockSQL_RS #indigo: <color:indigo>db \n<color:indigo>response 
