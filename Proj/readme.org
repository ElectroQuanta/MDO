...
***** ✔ DONE LocalTx
	  ...
	  - State "✔ DONE"     from              [2021-12-23 qui 18:07]
	  :END:
  #+BEGIN_SRC plantuml :file diags/plantuml/flowchart/output/local-tx.png
@startuml
'-----------------------
  note right
        <b>LocalTx</b>
...
@enduml
  ...
  #+RESULTS:
  [[file:diags/plantuml/flowchart/output/local-tx.png]]
...
***** ✔ DONE VideoMan
	  ...
	  :END:
  #+BEGIN_SRC plantuml :file diags/plantuml/flowchart/output/local-video-man.png
@startuml
!$end_bracket = "<b> </b>"
'-----------------------
  note right
...
@enduml
  ...
  #+RESULTS:
  [[file:diags/plantuml/flowchart/output/local-video-man.png]]

***** ✔ DONE FragMan
	  :LOGBOOK:
	  - State "✔ DONE"     from              [2021-12-23 qui 20:24]
	  :END:
  #+BEGIN_SRC plantuml :file diags/plantuml/flowchart/output/local-frag-man.png
@startuml
!$end_bracket = "<b> </b>"
'-----------------------
  note right
...
@enduml
  ...
  #+RESULTS:
  [[file:diags/plantuml/flowchart/output/local-frag-man.png]]
