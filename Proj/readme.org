...
Access Token:
1483403576558895106-QP9zQETPfPsHteQrAfJ0MgF6vygsq

Access Token secret
qBRdswUIHup9uhyJZDrvDHnRwpeIRdqdNRqzVTwO6BkJ4

#+END_EXAMPLE
** Access to Twitter API
 1) [-] Access to Twitter API: [[https://developer.twitter.com/en/docs/twitter-api/getting-started/getting-access-to-the-twitter-api][src]]
