...
3) [ ] Design the UI
   1) [ ] Draw the several UI views following [[id:9fbc087a-a9db-49d1-83ff-f16804ee72dc][method 2]]
      1) [ ] Welcome view: =MainWindow=
   ...
   2) [ ] Use dummy pushbuttons to navigate through the several UI views
